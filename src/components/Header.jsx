...
const style = {
    backgroundImage: `linear-gradient(to bottom, transparent, #080F28),url(https://image.tmdb.org/t/p/original/${moviesLimit[currentMovie].poster_path})`,
}

return (
    <section className="header" style={style}>
    <HeaderContent title={moviesLimit[currentMovie].original_title} date={moviesLimit[currentMovie].release_date} content={moviesLimit[currentMovie].overview}/>
    </section>
)
}
